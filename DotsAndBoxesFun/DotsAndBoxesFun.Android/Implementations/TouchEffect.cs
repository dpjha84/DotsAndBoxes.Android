...
using DotsAndBoxesFun.Droid.Implementations;
using Xamarin.Forms;
using Xamarin.Forms.Platform.Android;
using DotsAndBoxesFun;

[assembly: ResolutionGroupName("XamarinDocs")]
[assembly: ExportEffect(typeof(DotsAndBoxesFun.Droid.Implementations.TouchEffect), "TouchEffect")]
namespace DotsAndBoxesFun.Droid.Implementations
{
    public class TouchEffect : PlatformEffect
    {
        Android.Views.View view;
        Element formsElement;
        DotsAndBoxesFun.TouchEffect libTouchEffect;
        bool capture;
        ...
        protected override void OnAttached()
        {
            ...
            DotsAndBoxesFun.TouchEffect touchEffect =
                (DotsAndBoxesFun.TouchEffect)Element.Effects.
                    FirstOrDefault(e => e is DotsAndBoxesFun.TouchEffect);
